...
3. **Database Pooling:** We will enforce async connection pooling (`pool_size=20`, `max_overflow=10`, `pool_pre_ping=True`) to prevent connection starvation during network reconnection spikes.
